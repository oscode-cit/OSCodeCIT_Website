    ...
    <main className="future-home">
      ...
      <Container className="!max-w-[1580px]">
        ...
        <NeonFrame
          ...
          title="Builds That Move Ideas Forward"
          description="A compact view of OSCode CIT's active repositories and student-led engineering work."
        >
        ...
        <NeonFrame
          ...
          description="Workshops, summits, visits, and sessions that connect students with technology and open-source practice."
          className="home-section-frame"
        >
          <div className="future-grid three-col">
...
<<<<<<< HEAD
        <NeonFrame
          ...
          description="Recognition earned through technical work, industry exposure, mentorship, and community contribution."
          className="home-section-frame"
        >
          <div className="future-grid three-col">
